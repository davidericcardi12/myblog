...
window.onload = function (){
    ...
    let makeHistogram = function (n, time_step) {
        ...
        console.log(absoluteDistribution_ts);
                ...
                datasets: [
                    {
                        ...
                        backgroundColor: 'rgba(138, 43, 226, 1)', // Colore delle barre
                        borderColor: 'rgba(138, 43, 226, 1)',
                        borderWidth: 1,
                        minBarLength: 2 // Cambia questo valore in base alle tue esigenze
                    },
                    {
                        label: 'Absolute Distribution at time ' + time_step,
                        data: absoluteDistribution_ts.reverse(),
                        backgroundColor: 'rgba(138, 43, 226, 100)', // Colore delle barre
